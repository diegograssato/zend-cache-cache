 ...
 */
class Estados extends \Application\Entity\Estados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Estados' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Estados' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Estados' . "\0" . 'sigla');
        }
